...
function establishAndMaintainConnection$1(opts) {
  return establishAndMaintainConnection(opts, { WebSocket: browser, log: opts.log || log });
}
...
function waitAndContinue(options) {
  return new Promise((success, reject) => {
    const connector = establishAndMaintainConnection$1(options);
...
export { ConnectorPool, index as concurrency, establishAndMaintainConnection$1 as connect, establishAndMaintainConnection$2 as connectBrowser, newKeypair as newClientKeypair };
