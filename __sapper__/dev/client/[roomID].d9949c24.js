...
var peers = {
    ...
    actions: {
        ...
        togglePing({ state, dispatch }, id) {
            ...
            dispatch('setPinged', is_pinged ? '' : id).then(() => {
                if (!is_pinged && window)
                    window.scrollTo(0, 0);
            });
        },
