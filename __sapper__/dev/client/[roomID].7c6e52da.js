...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(span0, file$8, 50, 16, 1962);
			add_location(span1, file$8, 61, 16, 2411);
			attr_dev(div, "class", "toggle w-100 d-flex justify-center");
			add_location(div, file$8, 49, 12, 1897);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 83, 16, 3267);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file$8, 74, 16, 2891);
		},
		m: function mount(target, anchor) {
...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(audio, file$8, 46, 4, 1758);
			attr_dev(div0, "class", "w-100 p-0");
			add_location(div0, file$8, 72, 8, 2817);
			attr_dev(div1, "class", "w-100");
			add_location(div1, file$8, 47, 4, 1826);
