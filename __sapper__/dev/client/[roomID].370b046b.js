...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(span0, file$8, 50, 16, 1992);
			add_location(span1, file$8, 61, 16, 2441);
			attr_dev(div, "class", "toggle w-100 d-flex justify-center");
			add_location(div, file$8, 49, 12, 1927);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 83, 16, 3297);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file$8, 74, 16, 2921);
		},
		m: function mount(target, anchor) {
...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(video, "style", video_style_value = "background:#b3e5fc;" + /*vid_style*/ ctx[7]);
			video.autoplay = true;
			...
			add_location(audio, file$8, 46, 4, 1788);
			attr_dev(div0, "class", "w-100 p-0");
			add_location(div0, file$8, 72, 8, 2847);
			attr_dev(div1, "class", "w-100");
			add_location(div1, file$8, 47, 4, 1856);
			...
			attr_dev(div2, "style", div2_style_value = "background:#b3e5fc;" + /*main_style*/ ctx[4]);
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*vid_style*/ 128 && video_style_value !== (video_style_value = "background:#b3e5fc;" + /*vid_style*/ ctx[7])) {
			...
			if (!current || dirty & /*main_style*/ 16 && div2_style_value !== (div2_style_value = "background:#b3e5fc;" + /*main_style*/ ctx[4])) {
...
function create_if_block_3$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$a, 88, 3, 3316);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$a, 94, 4, 3490);
			attr_dev(div, "class", "alert d-block alert-danger lead");
			add_location(div, file$a, 93, 3, 3440);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, p);
...
function create_if_block_1$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$a, 128, 4, 4422);
			attr_dev(div, "class", "as-center d-flex justify-center");
			add_location(div, file$a, 127, 3, 4372);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
