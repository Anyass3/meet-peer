...
var streams = {
    ...
    actions: {
        ...
        toggleShareScreen({ state, g, dispatch, commit }) {
            console.log("g('getUserId');", g('getPeerVideoId', 'hmhmhgmgdd'));
...
var peers = {
    ...
    actions: {
        ...
        deletePeerScreen({ state, g, commit }, id) {
            const screens = get_store_value(state.screens);
            const screen = g('getPeerScreen', id);
