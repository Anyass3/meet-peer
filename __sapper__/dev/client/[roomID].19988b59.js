...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(span0, file$8, 48, 16, 1882);
			add_location(span1, file$8, 59, 16, 2331);
			attr_dev(div, "class", "toggle w-100 d-flex justify-center");
			add_location(div, file$8, 47, 12, 1817);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 81, 16, 3187);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file$8, 72, 16, 2811);
		},
		m: function mount(target, anchor) {
...
function instance$8($$self, $$props, $$invalidate) {
	...
	const click_handler = () => store.dispatch("togglePing", id);
