...
var socket$2 = {
    ...
    actions: {
        joinMeet: ({ state, commit, dispatch, g }, roomId) => {
            ...
            socket.on('connect', () => {
                console.log('reconnecting', get_store_value(state.reconnecting));
                ...
                if (get_store_value(state.joinRequest)) {
                    ...
                    if (get_store_value(state.reconnecting))
                        dispatch('setReconnecting', false);
                    else
                        dispatch('leaveMeet');
                }
