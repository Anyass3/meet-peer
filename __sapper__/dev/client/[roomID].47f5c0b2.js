...
var peers = {
    ...
    actions: {
        ...
        removePeer: ({ state, g, dispatch }, id) => {
            const peers = get_store_value(state.peers);
            const screens = get_store_value(state.screens);
            const peer = g(id); //Array.from(peers).find((i) => i['peerId'] === id);
            console.log(peer);
            peers.delete(peer);
