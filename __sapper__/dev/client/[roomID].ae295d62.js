...
var streams = {
    ...
    actions: {
        ...
        async captureScreen({ state, dispatch, commit }) {
            ...
            newScreenStream.getVideoTracks()[0].addEventListener('stopped', () => {
                dispatch('endedSharing');
            });
        },
