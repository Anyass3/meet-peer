    ...
    actions: {
        ...
        toggleShareScreen({ state, dispatch, commit }) {
            if (!get_store_value(state.sharingScreen))
                ...
                const screens = get_store_value(state.streams);
